...
filename2 = os.path.join(script_dir, 'result', '0.424_SP_ray_psi_h_lr1e-05_[256, 1024, 1024, 258]_ep700.pt')
...
save_path = os.path.join(script_dir, 'snr', 'SP_ray_i_h_vs_LS_LMMSE_mlp_10nmb.pdf')#  %(IRS_coef_type)
