...
# MLPs
filename1 = os.path.join(script_dir, 'trained_model', '1.477_eps7.0_inf_AE_psi_h_lr1e-03_[256, 1024, 256]_ep82.pt')
checkpoint1 = torch.load(filename1, weights_only=False, map_location=device)
filename2 = os.path.join(script_dir, 'trained_model', '1.594_eps5.0_inf_AE_psi_h_lr1e-03_[256, 1024, 256]_ep55.pt')
...
plt.plot(SNR_dB, NMSE_2.to('cpu'), label='PD AE $\\varepsilon=5$', linewidth=1, linestyle='-', marker='x', color="blue")  ###
plt.plot(SNR_dB, NMSE_1.to('cpu'), label='deeper PD AE $\\varepsilon=7$', linewidth=1, linestyle='-', marker='x', color="black")  ###
