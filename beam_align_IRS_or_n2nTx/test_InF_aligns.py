...
# MLPs
filename1 = os.path.join(script_dir, 'trained_model', '3.582_PD_inf_MLP_psi_ho_lr1e-03_[64, 1024, 66]_ep60.pt')
checkpoint1 = torch.load(filename1, weights_only=False)
filename2 = os.path.join(script_dir, 'trained_model', '3.168_PD_inf_MLP_psi_ha_lr1e-03_[64, 1024, 66]_ep56.pt')
...
plt.suptitle("ChEsts NMSE with IRS vs SNR in InF 2.5GHz")
