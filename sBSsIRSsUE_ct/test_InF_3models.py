...
# MLPs
filename1 = os.path.join(script_dir, 'trained_model/InF_trained_model', '1.581_SP_inf_MLP_psi_i_lr1e-03_[256, 1024, 258]_ep96.pt')
checkpoint1 = torch.load(filename1, weights_only=False)
filename2 = os.path.join(script_dir, 'trained_model/InF_trained_model', '1.580_SP_inf_MLP_psi_d_lr1e-03_[256, 1024, 258]_ep65.pt')
checkpoint2 = torch.load(filename2, weights_only=False)
filename3 = os.path.join(script_dir, 'trained_model/InF_trained_model', '1.708_SP_inf_MLP_psi_h_lr1e-03_[256, 1024, 258]_ep85.pt')
