...
from utils.NN_model.MLP_3layer_1024 import MLP
import os

# h_c, y, h_mean, h_std = importData(1000, 4, 8, 4, 32, 'cuda:0', 0, 'train', 'uma')
# print(h_c.shape)
...
def train(size, hidden_sizes=[64, 32], lr=1e-3, num_epochs = 3, 
    ...
    save_path = os.path.join(script_dir, 'trained_model', '%.3f_SP_%s_MLP_psi_%s_lr%.0e_%s_ep%s' 
...
if __name__ == '__main__':
    ...
    parser.add_argument('-tau', type=int, default=3)  # 10k length of trajectory = size of mini-batch
    ...
    train([args.nT, args.nI, args.nR, args.T], args.hsz, args.lr, args.ep, 10**args.tau, args.nmb, args.cuda, args.snr, args.ch, args.psi)
