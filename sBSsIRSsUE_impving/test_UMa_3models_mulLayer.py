...
from utils.IRS_ct_channels_8snr import importData
...
filename3 = os.path.join(script_dir, 'trained_model/comaring_models', '0.954_SP_uma_MLP_psi_h_lr1e-03_[256, 1024, 258]_ep103.pt')
...
filename5 = os.path.join(script_dir, 'trained_model', '0.730_8SNR_uma_10MLP_psi_h_lr1e-04_[256, 1024, 258]_ep104.pt')
...
data = {
    ...
    "2 layers MLP w/ H": NMSE_3.to('cpu'), "5 layers MLP w/ H": NMSE_4.to('cpu'), "10 layers MLP w/ H": NMSE_5.to('cpu'), 
    "channelNet w/ H": NMSE_6.to('cpu'), "ISTANet w/ H": NMSE_9.to('cpu')
}
df = pd.DataFrame(data)
save_path = os.path.join(script_dir, 'ChEsts_testing_performance', 'SP_%s_MLP_vs_CN_IN_mulL_8snr_.pdf'%(channel)) #  %(IRS_coef_type)
