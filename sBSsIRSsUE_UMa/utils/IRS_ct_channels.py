...
def importData(data_size, n_R, n_I, n_T, T, SNR_lin, device, IRScoef='identity', case = 'train', channel='default'):
    ...
    if channel.lower() == 'uma':
        if case == 'train':
            BI_file_path = './IRS_simulation/sBSsIRSsUE_UMa/channel/UMa_BI_train_1M_4_8_.mat'
            IU_file_path = './IRS_simulation/sBSsIRSsUE_UMa/channel/UMa_IU_train_1M_8_4_.mat'
        
        elif case == 'val':
            BI_file_path = './IRS_simulation/sBSsIRSsUE_UMa/channel/UMa_BI_val_2k_4_8_.mat'
            IU_file_path = './IRS_simulation/sBSsIRSsUE_UMa/channel/UMa_IU_val_2k_8_4_.mat'
        elif case == 'test':
            BI_file_path = './IRS_simulation/sBSsIRSsUE_UMa/channel/UMa_BI_test_24k_4_8_.mat'
            IU_file_path = './IRS_simulation/sBSsIRSsUE_UMa/channel/UMa_IU_test_24k_8_4_.mat'
    # elif channel.lower() == 'inf':
    #     file_path = './simulation/channel_realization/Dataset_InF_2_point_5_GHz.mat'
    else:
