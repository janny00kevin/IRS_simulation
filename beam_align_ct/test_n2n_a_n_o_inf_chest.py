...
# MLPs
filename1 = os.path.join(script_dir, 'trained_model', '0.122_PD_inf_MLP_str_a_a_lr1e-03_[64, 1024, 66]_ep56.pt')
checkpoint1 = torch.load(filename1, weights_only=False)
filename2 = os.path.join(script_dir, 'trained_model', '0.325_PD_inf_MLP_str_n_a_lr1e-03_[64, 1024, 66]_ep54.pt')
checkpoint2 = torch.load(filename2, weights_only=False)
filename3 = os.path.join(script_dir, 'trained_model', '0.123_PD_inf_MLP_str_o_a_lr1e-03_[64, 1024, 66]_ep89.pt')
...
plt.suptitle("ChEsts with diff tx steering NMSE vs SNR in InF 2.5GHz")
