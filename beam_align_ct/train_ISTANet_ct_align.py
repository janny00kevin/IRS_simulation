...
def train(size, hidden_sizes, lr, num_epochs, batch_size, num_minibatch, cuda, snr, channel='UMa', IRS_coe_type='h', num_layers=10, angle_config='x'):
    ...
    save_path = os.path.join(script_dir, 'trained_model', '%.3f_%s_ISTA_psi_%s%s_lr%.0e_ep%s' 
...
if __name__ == '__main__':
    ...
    train([args.nT, args.nR, args.nI, args.T], args.hsz, args.lr, args.ep, args.mbs, nmb, args.cuda, args.snr, args.ch, args.psi, args.lys, args.conf)
