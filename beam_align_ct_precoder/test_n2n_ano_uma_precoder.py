...
# MLPs
filename1 = os.path.join(script_dir, 'trained_model', '0.945_PD_uma_MLP_str_a_lr1e-03_[288, 1024, 290]_ep88.pt')
checkpoint1 = torch.load(filename1, weights_only=False)
filename2 = os.path.join(script_dir, 'trained_model', '1.003_PD_uma_MLP_str_n_lr1e-03_[288, 1024, 290]_ep75.pt')
checkpoint2 = torch.load(filename2, weights_only=False)
filename3 = os.path.join(script_dir, 'trained_model', '0.283_PD_uma_MLP_str_o_lr1e-03_[288, 1024, 290]_ep86.pt')
...
save_path = os.path.join(script_dir, 'ChEsts_testing_performance', 'beam_align_%s_ano_precoder_23p1.pdf'%(channel)) #  %(IRS_coef_type)
