function H = GENERATE_CHANNEL_BI(CH_MODEL, SCENARIO, LOS, f_c)
    % General setting for channel generation
    loc_BSs = [0; 0; 0];
    loc_UTs = [51; 0; 0];     % set distance between BSs and UT to be around 680 m in 2D [min 35 m in 2D]
    ori_BSs = [0 0 1;0 1 0;-1 0 0];
    ori_UTs = [0 0 -1;0 1 0;1 0 0];
    nTxxy = [2 2];
    nRxxy = [4 2];
    f_arr = [2 2]; % UPA n UPA
    f_scenario = SCENARIO;
