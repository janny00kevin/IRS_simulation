...
if channel == 'inf':
    ...
    filename3 = os.path.join(script_dir, 'trained_model', '3.510_8SNR_inf_5MLP_psi_h_lr1e-03_[4096, 1024, 4098]_ep74.pt')
    ...
    # checkpoint2 = torch.load(filename2, weights_only=False, map_location=device)
    filename3 = os.path.join(script_dir, 'trained_model', '1.122_8SNR_uma_5MLP_psi_h_lr1e-03_[4096, 1024, 4098]_ep64.pt')
    checkpoint3 = torch.load(filename3, weights_only=False, map_location=device)
