...
def import_data(data_size, n_R, n_I, n_T, T, SNR_lin, device, IRScoef='identity', phase = 'train', channel='default'):
    ...
    BI_file_name = channel.lower() + '_BI_' + phase_ + '_16_32_ori_.mat'
    IU_file_name = channel.lower() + '_IU_' + phase_ + '_32_4_ori_.mat'
    
    dataset_folder = os.path.abspath(os.path.join(current_path, '..', '..', 'channel_realization_16_32_4'))
