...
filename4 = os.path.join(script_dir, 'trained_model', '1.011_SP_uma_5MLP_psi_h_lr1e-04_[256, 1024, 258]_ep66.pt')
checkpoint4 = torch.load(filename4, weights_only=False, map_location=device)

filename5 = os.path.join(script_dir, 'trained_model', '0.895_SP_uma_10MLP_psi_h_lr1e-04_[256, 1024, 258]_ep126.pt')
