...
from utils.IRS_ct_channels_swin_SNR import importData
...
save_path = os.path.join(script_dir, 'ChEsts_testing_performance', 'SP_%s_MLP_vs_CN_IN_swinSNR_.pdf'%(channel)) #  %(IRS_coef_type)
