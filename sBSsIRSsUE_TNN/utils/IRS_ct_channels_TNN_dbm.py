...
def add_noise(recieve_sign, snr_lin, data_size, n_R, T, device, seed, phase, h_mean, h_std):
    ...
    if phase == 'train':
        recieve_sign = (recieve_sign * h_std) + h_mean

    # Ps = (recieve_sign.abs()**2).mean() # Power of the transmitted signal
    # Pn = Ps / snr_lin # Noise power
    Pn = torch.tensor([4.7299e-14, 2.9844e-14, 1.8830e-14, 1.1881e-14, 7.4965e-15, 4.7299e-15,
        2.9844e-15, 1.8830e-15])
