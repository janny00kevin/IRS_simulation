...
def importData(data_size, n_R, n_I, n_T, T, SNR_lin, device, IRScoef='identity', phase = 'train', channel='default'):
    ...
    if channel.lower() == 'uma':
        Pn = torch.tensor([4.7299e-14, 2.9844e-14, 1.8830e-14, 1.1881e-14, 7.4965e-15, 4.7299e-15, 2.9844e-15, 1.8830e-15])
    elif channel.lower() == 'inf':
        Pn = torch.tensor([3.8879e-06, 2.4531e-06, 1.5478e-06, 9.7660e-07, 6.1619e-07, 3.8879e-07, 2.4531e-07, 1.5478e-07])
