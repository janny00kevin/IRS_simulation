...
plt.plot(SNR_dB.flip(0), NMSE_3.to('cpu'), label='NP PD w/ Had', linewidth=1, linestyle='-', marker='x', color="tab:orange")  ###
...
save_path = os.path.join(script_dir, 'ChEsts_testing_performance', 'SP_%s_MLP_vs_CN_IN_TNN__.png'%(channel)) #  %(IRS_coef_type)
