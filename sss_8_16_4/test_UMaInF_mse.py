...
from utils.IRS_ct_channels_8snr_mse import import_data
...
### import testing data ###
h_test, y_test_h, h_mean, h_std = import_data(test_size, n_R, n_I, n_T, T, SNR_lin, device, IRScoef='h', phase = 'test', channel=channel, nmlz=True)
...
for idx, snr in enumerate(SNR_lin):
    ...
    with torch.no_grad():
        ...
        test_tbh_cplx = turn_cplx(logits3)
